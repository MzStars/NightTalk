...
namespace Infrastructure.Common
{
    ...
    public class ImgCaptcha
    {
        ...
        #region constructor
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Common.Utility.ImgCaptcha"/> class. default length is 4 with number list 
        /// </summary>
        public ImgCaptcha()
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Common.Utility.ImgCaptcha"/> class with number list;
        /// </summary>
        /// <param name="Length">Length.</param>
		public ImgCaptcha(int Length)
        {
			HttpContext.Current.Response.Expires = 0;
			HttpContext.Current.Response.Buffer = true;
			HttpContext.Current.Response.ExpiresAbsolute = DateTime.Now.AddSeconds(-1);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Common.Utility.ImgCaptcha"/> class.
        /// </summary>
        /// <param name="Length">Length.</param>
        /// <param name="type">Type 0 number , 1 char , 2 mixed.</param>
		public ImgCaptcha(int Length,int type)
		{
			HttpContext.Current.Response.Expires = 0;
			HttpContext.Current.Response.Buffer = true;
			HttpContext.Current.Response.ExpiresAbsolute = DateTime.Now.AddSeconds(-1);
