...
namespace Infrastructure.Common
{
    ...
    public class ConvertHelper
    {
        ...
        /// <summary>
        /// 实现各进制数间的转换。ConvertToBase("15",10,16)表示将十进制数15转换为16进制的数。
        /// </summary>
        /// <param name="value">要转换的值,即原值</param>
        /// <param name="from">原值的进制,只能是2,8,10,16四个值。</param>
        /// <param name="to">要转换到的目标进制，只能是2,8,10,16四个值。</param>
        /// <returns>返回值</returns>
        public static string toBase(string value, int from, int to)
        {
        ...
        /// <returns>返回值</returns>
        public static object ToObj(object data, Type targetType)
        {
            if (data == null || Convert.IsDBNull(data))
            {
                return null;
            ...
            if (targetType.IsEnum)
            {
                try
                {
                    return System.Enum.Parse(targetType, data.ToString(), true);
                }
                catch
                {
                    return System.Enum.ToObject(targetType, data);
                }
            }
        ...
        public static T ConvertTo<T>(object data)
        {
            ...
            object obj = ToObj(data, typeof(T));
            if (obj == null)
            {
                return default(T);
            }
        ...
        /// <summary>
        /// 将数据转换为DateTime  转换失败返回 1900-01-01
        /// </summary>
        /// <param name="data">数据</param>
        /// <param name="defValue">默认值</param>
        /// <returns>返回值 1900-01-01</returns>
        ...
        /// <param name="defValue">默认值</param>
        /// <returns>返回值</returns>
        public static Guid ToGuid(string data, Guid defValue)
        {
            //如果为空则返回默认值
            if (data == null || Convert.IsDBNull(data))
            {
            ...
            try
            {
                Guid val = Guid.Parse(data.ToString());
                if (val == Guid.Empty)
                {
                    return defValue;
                }
        ...
        /// <param name="defValue">默认值</param>
        /// <returns>返回值</returns>
        public static Guid ToGuid(object data, Guid defValue)
        {
            //如果为空则返回默认值
            if (data == null || Convert.IsDBNull(data))
            {
        ...
        public static string ToString(object data, string defValue)
        {
            //如果为空则返回默认值
            if (data == null || Convert.IsDBNull(data))
            {
